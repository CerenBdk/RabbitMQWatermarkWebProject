...
namespace WatermarkWebProject.Services
{
    public class RabbitMQPublisher
    {
        ...
        public void Publish(ProductImageCreatedEvent productImageCreatedEvent) {
            ...
            channel.BasicPublish(RabbitMQClientService.ExchangeName, RabbitMQClientService.RoutingWaterMark, property, bodyByte);
        }
    }
}
